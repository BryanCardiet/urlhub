    ...
    <div class="pt-16 sm:pt-28">
        @if (! auth()->check() )
            <div class="flex flex-wrap md:justify-center">
                <div class="w-full md:w-8/12 font-thin text-5xl text-slate-600 text-center welcome-msg"> Directorio Policial del Perú</div>
            </div>
        ...
        @else
            <div class="flex flex-wrap md:justify-center">
                ...
                >
                    Acortador <br>
                    <span class="font-thin text-black">Directorio Policial del Perú</span>
                </h1>
            </div>
